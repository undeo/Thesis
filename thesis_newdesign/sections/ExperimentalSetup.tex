...
\begin{figure}[t]
	\centering
	\includegraphics[width=0.8\textwidth]{../plots/expsetup/lhc.pdf}
...
\begin{figure}
	...
	\end{minipage}
	\caption[Integrated luminosity of the LHC in 2015 and 2016]{Integrated luminosity of the LHC in 2015 (a) and 2016 (b), taken from 	\cite{cmslumi}. Shown are the integrated luminosity delivered by the LHC (blue) and the integrated luminosity actually recorded by CMS.}
\end{figure}
