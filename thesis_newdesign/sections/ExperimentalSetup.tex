...
\begin{figure}
	...
	\begin{minipage}{0.5\textwidth}
		\subfigure[]{
			\includegraphics[width=\textwidth]{../plots/expsetup/lumi15.pdf}
			\label{fig:expsetup:lumi15}
		}
	\end{minipage}%
	\begin{minipage}{0.5\textwidth}
		\subfigure[]{
			\includegraphics[width=\textwidth]{../plots/expsetup/lumi16.pdf}
			\label{fig:expsetup:lumi16}
		}
	\end{minipage}
...
\noindent In the coordinate system used by CMS has its origin centered at the collison point. The y-axis points upward, the x-axis to the center of the LHC and the z-axis along the beam axis. Other used coordinates are the azimuthal angle $\phi$, which is measured from the x-axis in the x-y-plane, and the polar angle $\theta$, which is measured from the z-axis in counterclockwise direction. Instead of $\theta$, the rapidity $w$ can be used, which is defined as
\begin{equation}
...
\end{equation}
Another commonly used coordinate is the radius $r$, which is given as the distance from the beam line.\\
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\textwidth]{../plots/expsetup/ecal.pdf}
...
\begin{figure}
	\centering
	\includegraphics[width=0.95\textwidth]{../plots/expsetup/hcal.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{../plots/expsetup/muonsys.pdf}
