...
The Standard Model of particle physics (SM) summariyes the theories of elementary particles and their interactions. Since its development between 1960 and 1970, the fundamental paramters of the SM have been measured with ever increasing accuracy. Predictions made by the SM, like the existence of new particles, have been confirmed many times. With the detection of the top-quark in 1995 \cite{top_detection1,top_detection2}, the tau-neutrino in 2000 \cite{tau_nu_detection} and the Higgs boson in 2012 \cite{cms_higgsdiscov,atlas_higgsdiscov}, the last missing particles of the SM has been observed.\\
