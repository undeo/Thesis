...
\begin{figure}
	...
	\caption[Resulting fit to the W+jets shape in the \MWV -spectrum in the sideband region]{Resulting fit to the W+jets shape in the \MWV -spectrum in the sideband region for the electron (left) and muon channel (right). In this fit the shape of the W+jets production is extracted while all other shapes as well as the normalizations are fixed. The shown uncertainty includes statistical uncertainties only.}	
