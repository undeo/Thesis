...
\begin{figure}
	\centering
	\subfigure[]{
		\includegraphics[width=0.4\textwidth]{plots/bkg/feynmans/SMWW.pdf}
%		\caption{}
		\label{fig:bkg:fy_WWtgc}
	}
	\subfigure[]{
		\includegraphics[width=0.4\textwidth]{plots/bkg/feynmans/SMWZ.pdf}
		%\caption{}
		\label{fig:bkg:fy_WZtgc}
	}
	\subfigure[]{
		\includegraphics[width=0.4\textwidth]{plots/bkg/feynmans/SMWW2.pdf}
		%\caption{}
		\label{fig:bkg:fy_WWSM}
	}
	\subfigure[]{
		\includegraphics[width=0.4\textwidth]{plots/bkg/feynmans/SMWZ2.pdf}
		%\caption{}
		\label{fig:bkg:fy_WZSM}
	}
	\subfigure[]{
		\includegraphics[width=0.4\textwidth]{plots/bkg/feynmans/stoptW.pdf}
		%\caption{}
		\label{fig:bkg:fy_stoptw}
	}
	\subfigure[]{
		\includegraphics[width=0.4\textwidth]{plots/bkg/feynmans/stops.pdf}
%		\caption{}
...
\begin{figure}
	\centering
		\includegraphics[width=0.47\textwidth]{plots/bkg/mj/WJets_mj_el_ErfExp_with_pull.pdf}
		\includegraphics[width=0.47\textwidth]{plots/bkg/mj/WJets_mj_mu_ErfExp_with_pull.pdf}
		\includegraphics[width=0.47\textwidth]{plots/bkg/mj/TTbar_mj_el_2Gaus_ErfExp_with_pull.pdf}
		\includegraphics[width=0.47\textwidth]{plots/bkg/mj/TTbar_mj_mu_2Gaus_ErfExp_with_pull.pdf}
		\includegraphics[width=0.47\textwidth]{plots/bkg/mj/STop_mj_el_ExpGaus_with_pull.pdf}
		\includegraphics[width=0.47\textwidth]{plots/bkg/mj/STop_mj_mu_ExpGaus_with_pull.pdf}
		\includegraphics[width=0.47\textwidth]{plots/bkg/mj/VV_mj_el_2_2Gaus_with_pull.pdf}
		\includegraphics[width=0.47\textwidth]{plots/bkg/mj/VV_mj_mu_2_2Gaus_with_pull.pdf}
...
\begin{figure}
	\centering
		\includegraphics[width=0.49\textwidth]{plots/bkg/mj/mj_prefit_el.pdf}		
		\includegraphics[width=0.49\textwidth]{plots/bkg/mj/mj_prefit_mu.pdf}
		\includegraphics[width=0.49\textwidth]{plots/bkg/mj/bkg_el_mj.pdf}
		\includegraphics[width=0.49\textwidth]{plots/bkg/mj/bkg_mu_mj.pdf}	
		\includegraphics[width=0.49\textwidth]{plots/bkg/mj/bkg_alt_el_mj.pdf}
		\includegraphics[width=0.49\textwidth]{plots/bkg/mj/bkg_alt_mu_mj.pdf}
